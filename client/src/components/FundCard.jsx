...
const FundCard = ({
  ...
  const remDays = daysLeft(deadline);
 

  return (
    <div
      className=" sm:w-[288px] m-3 w-full rounded-[15px] bg-[#f0eaea] cursor-pointer"
      onClick={handleClick}
    >
      <img
        src={image}
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">{remDays}</h4>
