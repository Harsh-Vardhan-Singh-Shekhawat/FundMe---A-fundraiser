  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[459px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
        ...
        />
        <div className="w-[72px] h-full rounded-[32px] bg-[#4acd8d] flex justify-center items-center cursor-pointer">
          <img
            src={search}
            alt="search"
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        ...
        />
        <Link to="/profile">
          <div className="w-[52px] h-[52px] rounded-full flex bg-[#2c2f32] justify-center items-center cursor-pointer ">
            <img
              src={thirdweb}
              alt="user"
